...
import com.sparklink.addressservice.repository.AddressRepository;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.sparklink.addressservice.exception.AddressInfoByAddressTypeNotFoundException;
import com.sparklink.addressservice.exception.AddressInfoByCityNotFoundException;
import com.sparklink.addressservice.exception.AddressInfoByEmployeeIDNotFoundException;
...
public class AddressService {
	...
	public List<Address_Master> getAddressByCity(String permCity) {
		...
		//return addressRepository.getAddress(id).orElseThrow(() -> new AddressNotFoundException(id));;
		List<Address_Master> addressList = addressRepository.getAddressByCity(permCity);
			if(addressList == null) throw new AddressInfoByCityNotFoundException(permCity);
		return addressList;
	}
